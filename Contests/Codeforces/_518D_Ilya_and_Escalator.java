 ...
 * already on escalator then we make transition
 * z[i + 1][j] +  = z[i][j]. Else, or person number j go to
 * escalator in i + 1 second, i. e.
 * z[i + 1][j + 1] +  = z[i][j] * p, or person number j
 * stays on his place, i. e.
 * z[i + 1][j] +  = z[i][j] * (1 – p).
 */
