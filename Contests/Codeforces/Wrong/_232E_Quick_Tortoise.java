...
public class _232E_Quick_Tortoise {
	public static void main(String[] args) {
		...
		// for (int j = 0; j < fillGrid[0].length; j++) {
		// System.err.print((i * grid[0].length + j) + ": ");
		// System.err.println(fillGrid[i][j].toString());
		// }
		// }
	...
	private static void fill(int[][] grid, HashSet[][] fillGrid, int x, int y,
			int i, int j) {
		if ((i >= fillGrid.length) || (j >= fillGrid[0].length)
				|| grid[i][j] != 1)
			return;
