...
public class SortLargeFile {
    ...
    public static void createLargeFile() throws Exception {
	DataOutputStream output = new DataOutputStream(
		new BufferedOutputStream(new FileOutputStream("res/largedata.dat")));
	...
	sort("res/largedata.dat", "res/sortedfile.dat");

	// Display the first 100 numbers in the sorted file
	displayFile("res/sortedfile.dat");
    }
	...
	int numberOfSegments = initializeSegments(MAX_ARRAY_SIZE, sourcefile, "res/f1.dat");

	// Implement Phase 2: Merge segments recursively
	merge(numberOfSegments, MAX_ARRAY_SIZE, "res/f1.dat", "res/f2.dat", "res/f3.dat", targetfile);
    }
	...
	// Copy half number of segments from res/f1.dat to res/f2.dat
    ...
    /** Copy first half number of segments from res/f1.dat to res/f2.dat */
