...
public class TreeCellRendererEditorDemo extends JApplet {
	...
	ImageIcon yourCustomLeafImageIcon = new ImageIcon(getClass().getResource("/image/caIcon.gif"));
	ImageIcon yourCustomOpenImageIcon = new ImageIcon(getClass().getResource("/image/flag16.gif"));
	ImageIcon yourCustomClosedImageIcon = new ImageIcon(getClass().getResource("/image/rbs.gif"));

	public TreeCellRendererEditorDemo() {
		JTree jTree1 = new JTree();
		getContentPane().add(new JScrollPane(jTree1), BorderLayout.CENTER);
		...
		jTree1.setCellEditor(new javax.swing.tree.DefaultTreeCellEditor(jTree1,
						new javax.swing.tree.DefaultTreeCellRenderer(), new javax.swing.DefaultCellEditor(jcboColor)));
