...
public class ResourceBundleDemo extends JApplet {
	...
	jtfFormattedInterestRate.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfFormattedNumberOfYears.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfFormattedLoanAmount.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfTotalPayment.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfMonthlyPayment.setHorizontalAlignment(SwingConstants.RIGHT);
