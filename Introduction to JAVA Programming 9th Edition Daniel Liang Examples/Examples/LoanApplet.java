...
public class LoanApplet extends JApplet {
	...
	jtfAnnualInterestRate.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfNumberOfYears.setHorizontalAlignment(SwingConstants.RIGHT);
	jtfLoanAmount.setHorizontalAlignment(SwingConstants.RIGHT);
