...
public class CalendarPanel extends JPanel {
	...
	public CalendarPanel() {
		...
		for (int i = 0; i < 49; i++) {
			...
			jlblDay[i].setHorizontalAlignment(SwingConstants.RIGHT);
			jlblDay[i].setVerticalAlignment(SwingConstants.TOP);
		}
	...
	private void showDayNames() {
		...
		for (int i = 0; i < 7; i++) {
			...
			jlblDay[i].setHorizontalAlignment(SwingConstants.CENTER);
