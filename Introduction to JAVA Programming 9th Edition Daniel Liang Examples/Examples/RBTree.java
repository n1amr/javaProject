...
public class RBTree<E extends Comparable<E>> extends BST<E> {
	 ...
	 */
	private void restructureRecolor(RBTreeNode<E> a, RBTreeNode<E> b, RBTreeNode<E> c, RBTreeNode<E> w,
	...
	@Override
	/**
	 * Delete an element from the RBTree. Return true if the element
	 * is deleted successfully Return false if the element is not in
	 * the tree
	 */
	 ...
	 */
	private void fixDoubleBlack(RBTreeNode<E> grandparent, RBTreeNode<E> parent, RBTreeNode<E> db,
