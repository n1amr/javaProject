...
class TheTour extends JApplet {
    ...
    */
    ...
    static private int[][] analysis = { { 4, 5, 3, 6, 6, 6, 5, 6 }, { 2, 5, 7, 7, 2, 3, 6, 5 },
	    { 4, 5, 1, 1, 1, 2, 1, 5 }, { 4, 8, 3, 4, 7, 7, 5, 8 }, { 4, 5, 2, 2, 6, 6, 4, 8 },
	    { 1, 5, 1, 8, 7, 7, 1, 7 }, { 3, 3, 3, 6, 3, 3, 1, 6 }, { 2, 8, 2, 2, 2, 7, 1, 8 } };
	...
	*/
	...
	private void updateByOne() {
		...
		path[oldY][oldX] = 1;
		if (knightX > 7 || knightX < 0 || knightY > 7 || knightY < 0) {
		    System.out.println("Error: " + oldX + "  " + oldY + "\n" + knightX + " " + knightY + "\n"
			    + analysis[oldY][oldX]);
		    System.exit(0);
		}
