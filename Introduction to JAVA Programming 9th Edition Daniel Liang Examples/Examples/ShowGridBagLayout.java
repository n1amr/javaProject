...
public class ShowGridBagLayout extends JApplet {
	...
	private JLabel jlbl = new JLabel("Resize the Window and Study GridBagLayout", JLabel.CENTER);
	 ...
	 */
	private void addComp(Component c, Container container, GridBagConstraints gbConstraints, int row, int column,
