...
public class AVLTreeAnimation extends JApplet {
	...
	/*
	 * tree.insert(50); tree.insert(25); tree.insert(75); tree.insert(12);
	 * tree.insert(30); tree.insert(70); tree.insert(80); tree.insert(110);
	 * tree.insert(10);
	 */
	setUI();
    }
    ...
    static class AVLTree<E extends Comparable<E>> extends BST<E> implements Cloneable {
	...
	private void addDecendantsToSet(TreeNode<E> root, java.util.HashSet<TreeNode<E>> set) {
	    if (root != null) {
		set.add(root);
		addDecendantsToSet(root.left, set);
		addDecendantsToSet(root.right, set);
	    }
	}
