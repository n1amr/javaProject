...
public class AddressRegistration {
	...
	return !(lastName == null || firstName == null || lastName.trim().length() == 0
	...
	return "<p style=\"color:red\">You entered <br />" + "Last Name: " + lastName + "<br />" + "First Name: "
		+ firstName + "<br />" + "MI: " + mi + "<br />" + "Telephone: " + telephone + "<br />" + "Email: "
		+ email + "<br />" + "Street: " + street + "<br />" + "City: " + city + "<br />" + "Street: " + street
		+ "<br />" + "City: " + city + "<br />" + "State: " + state + "<br />" + "Zip: " + zip + "</p>";
    }
